...
public class CC5XMakeRuntimeProperties {
    public CC5XMakeRuntimeProperties(MakeConfigurationBook projectDescriptor, MakeConfiguration conf,Properties commandLineProperties) {
    ...
    public boolean getCompilerMode(MakeConfigurationBook projectDescriptor, MakeConfiguration conf) {
        ...
        OptionConfiguration confObject = projectDescriptor.getSynthesizedOptionConfiguration(conf.getName(), "cc5x-mode", null);
        if (confObject != null) {
